...
const DataTable = dynamic(() => import('../../invoices/_components/data-table'), { ssr: false, loading: () => <DataTableSkeleton columns={columns({ refreshData: () => {} })} /> });
...
function InvoiceList() {
    ...
    const memoizedColumns = React.useMemo(() => columns({ refreshData: () => fetchInvoices() }), [fetchInvoices]);
