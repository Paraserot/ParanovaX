        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input id="label" placeholder="e.g., Technical Support" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="assigneeId">Auto-Assign To (Optional)</FormLabel>
                   <Select onValueChange={field.onChange} value={field.value}>
                        <FormControl><SelectTrigger id="assigneeId" name="assigneeId"><SelectValue placeholder="Manual Assignment" /></SelectTrigger></FormControl>
                        <SelectContent>
