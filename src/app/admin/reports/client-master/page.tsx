...
const DataTable = dynamic(() => import('../../clients/_components/data-table'), { ssr: false, loading: () => <DataTableSkeleton columns={columns({ onEdit: () => {}, refreshData: () => {}, clientTypeMap: new Map() })} /> });
...
function ClientList() {
    ...
    const memoizedColumns = React.useMemo(() => columns({ onEdit: handleEdit, refreshData: () => fetchClients(), clientTypeMap }), [clientTypeMap, fetchClients]);
