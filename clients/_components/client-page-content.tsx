...
const DataTable = dynamic(() => import('./data-table'), {
    ssr: false,
    loading: () => <DataTableSkeleton columns={columns({onEdit: ()=>{}, clientTypeMap: new Map(), refreshData: ()=>{}})} />
});
...
const ClientTableWrapper = React.memo(() => {
    ...
    const memoizedColumns = useMemo(() => columns({ onEdit: handleEdit, clientTypeMap, refreshData: fetchClients }), [handleEdit, clientTypeMap]);
    ...
    return (
        <>
            <Card className="interactive-card">
                ...
                <CardContent>
                    <Suspense fallback={<DataTableSkeleton columns={columns({onEdit: ()=>{}, clientTypeMap: new Map(), refreshData: ()=>{}})} />}>
                        <ClientTableWrapper />
                    </Suspense>
                </CardContent>
            </Card>
