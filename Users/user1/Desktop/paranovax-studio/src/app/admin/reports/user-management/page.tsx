...
const DataTable = dynamic(() => import('../../users/_components/data-table').then(m=>m.DataTable), { ssr: false, loading: () => <DataTableSkeleton columns={columns({onEdit: () => {}, refreshData: () => {}, rolesMap: new Map()})} /> });
