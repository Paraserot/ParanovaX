...
const EntityDataTable = dynamic(() => import('../../entities/_components/entity-data-table').then(m => m.EntityDataTable), { ssr: false, loading: () => <DataTableSkeleton columns={columns} /> });
